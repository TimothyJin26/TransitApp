    ...
    WidgetsBinding.instance.addObserver(LifecycleEventHandler(
        resumeCallBack: () async => setState(() {
              if (hasLoaded) {
                ...
                // Force map to rerender to prevent white screen
                if (darkModeOn) {
